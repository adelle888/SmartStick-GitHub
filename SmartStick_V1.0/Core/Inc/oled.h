...
extern void WriteCmd(void);
extern void OLED_WR_CMD(uint8_t cmd);
extern void OLED_WR_DATA(uint8_t data);
...
extern void OLED_ShowNum(uint8_t x,uint8_t y,unsigned int num,uint8_t len,uint8_t size2);
extern void OLED_ShowChar(uint8_t x,uint8_t y,uint8_t chr,uint8_t Char_Size);
extern void OLED_ShowString(uint8_t x,uint8_t y,uint8_t *chr,uint8_t Char_Size);
